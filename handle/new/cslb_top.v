module load_balancer_top #(
    ...
    // 1. Reset Logic Fix
    //============================================================
    // C�c module con (FIFO) d�ng Reset m?c 1 (Active High)
    // Module Top d�ng Reset m?c 0 (Active Low) -> C?n ??o bit
...
//    wire [KEY_WIDTH-1:0] key_fifo_data;
    ...
    wire                 sync_key_empty;
    wire                 sync_key_valid; // FIX: Th�m d�y n�y
    wire                 rd_sync_key;
    ...
    wire                   msg_empty;
    wire                   msg_fifo_valid; // FIX: Th�m d�y n�y
    wire                   rd_msg_en;
...
//};
    ...
    algorithm_selector #(
        ...
        .clock        (clk),
        .rst_n        (rst_n), // Module n�y d�ng rst_n
...
//        .key_data     (key_fifo_data),
    ...
    dst_fifo #(
        ...
        .rd_valid  (sync_key_valid),    // FIX: N?i d�y valid v�o ?�y
    ...
    msg_fifo u_msg_fifo (
        ...
        .msg_data      (msg_data),
        .msg_valid     (msg_fifo_valid), // FIX: N?i d�y valid v�o ?�y
        .msg_last      (msg_last),
        .msg_keep      (msg_keep),
        .o_empty       (msg_empty),
        .rd_msg_en     (rd_msg_en)
    ...
    sync_logic #(
        ...
        .key_valid     (sync_key_valid), // FIX: ?� c� t�n hi?u t? dst_fifo
        .rd_key_en     (rd_sync_key),

        // Msg Path Connection
        .msg_data      (msg_data),
        .msg_last      (msg_last),
        .msg_valid     (msg_fifo_valid), // FIX: ?� c� t�n hi?u t? msg_fifo
        .msg_keep      (msg_keep),
        .msg_empty     (msg_empty),
        .rd_msg_en     (rd_msg_en),
