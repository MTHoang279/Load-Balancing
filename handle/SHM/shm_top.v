...
module shm_top #(
    ...
    // Health update valid: delay by 1 cycle to align with bitmap register update
    reg cslb_health_update_valid_r;
    always @(posedge clk or negedge rst_n) begin
        if (!rst_n) cslb_health_update_valid_r <= 1'b0;
        else        cslb_health_update_valid_r <= sst_health_update_valid;
    end
    assign cslb_health_update_valid = cslb_health_update_valid_r;
    ...
    shm_parser #(
        ...
        .parser_server_ip     (server_ip),
        .parser_response_ready(1'b1)
    );
    ...
    sst_reg_file #(
        ...
        .wr_scn        (sst_wr_scn),
        .hb_wr_en      (parser_response_valid),
        .hb_wr_addr    (parser_server_id),
        .hb_wr_ip      (server_ip),
        .rd_addr       (sst_rd_addr),
        .rd_ip         (sst_rd_ip),
        .rd_scn        (sst_rd_scn),
