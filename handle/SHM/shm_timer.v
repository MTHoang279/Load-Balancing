module shm_timer #(
    ...
    localparam TICKS_1S  = 1000 / TICK_MS;
    localparam TICKS_10S = 10000 / TICK_MS;
    ...
    reg rst_n_d;  // delay register ?? detect c?nh lên
    ...
    assign rst_rise = rst_n & ~rst_n_d;

    //==================================================
    // Clock counter ? t?o tick 10ms
    //==================================================
    ...
    //==================================================
    // 1s heartbeat generator + reset trigger
    //==================================================
    ...
    //==================================================
    // 10s heartbeat checker (gi? nguyên)
    //==================================================
