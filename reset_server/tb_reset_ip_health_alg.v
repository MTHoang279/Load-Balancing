...
//    localparam SERVER_ID_WIDTH = 2;
//    localparam SCN_WIDTH       = 4;

//    localparam [31:0] IP0 = 32'h0A000064;
//    localparam [31:0] IP1 = 32'h0A000065;
//    localparam [31:0] IP2 = 32'h0A000066;
//    localparam [31:0] IP3 = 32'h0A000067;
...
//        input [31:0] ip;
//        begin
//            is_known_ip = (ip == IP0) || (ip == IP1) || (ip == IP2) || (ip == IP3);
//        end
//    endfunction
...
//        if (cslb_rd_ip[0*32 +: 32] !== IP0 ||
//            cslb_rd_ip[1*32 +: 32] !== IP1 ||
//            cslb_rd_ip[2*32 +: 32] !== IP2 ||
//            cslb_rd_ip[3*32 +: 32] !== IP3) begin
//            $display("[TB][FAIL] IP snapshot mismatch after reset: %h", cslb_rd_ip);
//            $fatal;
//        end
...
//        if (last_user_dst_ip !== IP0) begin
//            $display("[TB][FAIL] RR pkt1 expected %h got %h", IP0, last_user_dst_ip);
//            $fatal;
//        end
...
//        wait_user_packet(prev_tx_count, 400);
//        if (last_user_dst_ip !== IP1) begin
//            $display("[TB][FAIL] RR pkt2 expected %h got %h", IP1, last_user_dst_ip);
//            $fatal;
//        end
