...
//    // ========================================
//    wire [N*N-1:0]  total_score_w;
//    wire            pipe_valid_s2;
//    wire [N-1:0]    server_valid_w2;

//    reg  [N*N-1:0]  total_score_r;
//    reg             pipe_valid_r2;
...
//    // Stage 4: Output
//    // ========================================
//    function [IDX_W-1:0] first_valid_idx;
//        input [N-1:0] valid_mask;
//        integer fv_i;
//        reg found;
//        begin
//            first_valid_idx = {IDX_W{1'b0}};
//            found = 1'b0;
//            for (fv_i = 0; fv_i < N; fv_i = fv_i + 1) begin
//                if (!found && valid_mask[fv_i]) begin
//                    first_valid_idx = fv_i[IDX_W-1:0];
//                    found = 1'b1;
//                end
//            end
//        end
...
//    wire [IDX_W-1:0] best_index_safe_w;
//    wire [31:0]      dst_ip_next;
//    wire             dst_valid_next;
//    wire [IDX_W-1:0] best_index_next;

//    assign best_index_safe_w = server_valid_r3[best_index_r] ? best_index_r : first_valid_idx(server_valid_r3);
//    assign dst_valid_next  = pipe_valid_r3 && (|server_valid_r3);
//    assign dst_ip_next     = pipe_valid_r3 ? server_ip[best_index_safe_w*32 +: 32] : 32'b0;
//    assign best_index_next = pipe_valid_r3 ? best_index_safe_w : {IDX_W{1'b0}};
