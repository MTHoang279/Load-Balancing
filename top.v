module fpga_top#(
    ...
    parameter CLK_FREQ_HZ = 300000000,
...
//    input  wire        clk_n,  
    ...
    input  wire        start,      // Asynchronous Input
    input  wire [1:0]  algo_sel,
//    input  wire        loop_en,
    output wire        done,
    input  wire        tx_backend_ready,     // tready t? sync FIFO
...
//    );
    ...
    wire  [3:0]                 server_idx;  // idx comes with scn increment
    wire                        ready_shm2cslb;
...
//    );
    ...
    load_balancer_top u_core (
        .clk            (clk), // S?A: clk -> clk_core
        .rst_n          (rst_n),
...
//        .probe3 (m_axis_tlast), 
//        .probe4 (axis_tready)     // S?A: N?i v?o axis_tready ?? debug t?t h?n
//    );
